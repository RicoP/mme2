...
public class _Super_Root extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.Cat.initRemoteClassAliasSingleChild();
    }
    ...
    private var _internal_cat : ArrayCollection;
    model_internal var _internal_cat_leaf:valueObjects.Cat;
    ...
    [Bindable(event="propertyChange")]
    public function get cat() : ArrayCollection
    {
    ...
    public function set cat(value:*) : void
    {
        var oldValue:ArrayCollection = _internal_cat;
        if (oldValue !== value)
        {
            ...
            {
                _internal_cat = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_cat = null;
            ...
            {
                throw new Error("value of cat must be a collection");
            }
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "cat", oldValue, _internal_cat));
        }
    }
